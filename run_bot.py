...
class BotWithCommands:
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            ...
            "📌 Доступные команды:\n"
            "/send_events - События на сегодня\n"
...
<b>Команды:</b>
/send_events — Получить события на сегодня
/choose_date — Выбрать дату из календаря
/help — Показать эту справку

<b>Как использовать:</b>
1. Отправьте /send_events для событий на сегодня
...
Вопросы и предложения: svet@rsl.ru
    ...
    async def send_events_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """Обработчик команды /send_events - отправляет события на сегодня"""
        ...
        logger.info(f"Команда send_events выполнена для чата {chat_id}")
    ...
    async def run_polling(self):
        ...
        print("   /send_events - События на сегодня")
